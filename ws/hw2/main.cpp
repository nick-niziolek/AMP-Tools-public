...
int main(int argc, char** argv) {
    ...
    */
    ...
    int j = 0;
    {
        while (random_trial_success && (j < 1)) { // Keep trying until you fail
            j++;
            ...
            if (!random_trial_success) {
                // Visualize the failed path and environment
    ...
    //HW2::grade(algo, "nicholas.niziolek@colorado.edu", argc, argv);
