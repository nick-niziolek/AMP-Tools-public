...
int main(int argc, char** argv) {
    ...
    Manipulator2D manipulator(std::vector<double>{1.0,1.0}); // 3-link manipulator
    ...
    amp::ManipulatorState test_state = manipulator.getConfigurationFromIK(Eigen::Vector2d(1.3,1.3));
